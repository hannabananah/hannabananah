...
## 💼 Career & Activity
- **삼성 청년 SW 아카데미 (SSAFY) 실습코치** (2025.01 ~ 2025.12)  
   → 12,13기 교육생 대상 프로젝트/AI 코칭 및 오픈소스 리팩토링, SSAFY AI Agent 등의 내부 프로그램 개발 및 유지보수
...
## 🏆 Award & Certification
- **AWS Certified Solutions Architect-Professional(SAP)** 자격증 취득 (2026.01)
- **2025 ProfitLab Hackathon SWYP Award 수상** (2025.12)
- **데이터 분석 준전문가(ADsP)** 자격증 취득 (2025.11)
- **SQL 개발자(SQLD)** 자격증 취득 (2025.04)
